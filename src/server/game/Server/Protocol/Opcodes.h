////////////////////////////////////////////////////////////////////////////////
// Draenor-Core opcodes adapted to TrinityCore 6.2.4.21742
////////////////////////////////////////////////////////////////////////////////
...
enum OpcodeServer : uint32
{
    ...
    SMSG_ACCOUNT_HEIRLOOM_UPDATE                    = 0x254B,
...
// Unified enum so existing Draenor send/recv sites keep compiling.
enum Opcodes : uint32
{
    CMSG_ACCEPT_GUILD_INVITE                        = 0x357B,
    CMSG_ACCEPT_LEVEL_GRANT                         = 0x3463,
    ...
    SMSG_XP_GAIN_ENABLED                            = 0x2762,
    SMSG_ZONE_UNDER_ATTACK                          = 0x2B38,
    CMSG_CHAR_CREATE                                = 0x35CA,
    CMSG_CHAR_ENUM                                  = 0x3568,
    CMSG_CREATURE_QUERY                             = 0x31C5,
    CMSG_GAMEOBJECT_QUERY                           = 0x31C6,
    CMSG_GARRISON_CHANGE_FOLLOWER_ACTIVATION_STATE  = 0x3222,
    CMSG_GARRISON_REQUEST_BUILDINGS                 = 0x320F,
    CMSG_GARRISON_REQUEST_UPGRADEABLE               = 0x3261,
    CMSG_GET_SHIPMENT_INFO                          = 0x3234,
    CMSG_MESSAGECHAT                                = 0x376D,
    CMSG_NAME_QUERY                                 = 0x361B,
    CMSG_NPC_TEXT_QUERY                             = 0x31C7,
    CMSG_PAGE_TEXT_QUERY                            = 0x31C9,
    CMSG_PET_NAME_QUERY                             = 0x31CA,
    CMSG_QUEST_QUERY                                = 0x31C8,
    SMSG_CHAR_CREATE                                = 0x26C0,
    SMSG_CHAR_DELETE                                = 0x26C1,
    SMSG_CHAR_ENUM                                  = 0x2500,
    SMSG_COMPRESSED_MOVES                           = 0x2FCF,
    SMSG_COMPRESSED_UPDATE_OBJECT                   = 0x277D,
    SMSG_ENUM_CHARACTERS                            = 0x2500,
    SMSG_GAMEOBJECT_QUERY_RESPONSE                  = 0x267E,
    SMSG_GARRISON_BLUEPRINT_AND_SPECIALIZATION_DATA = 0x2877,
    SMSG_GARRISON_GET_BUILDINGS_DATA                = 0x28A3,
    SMSG_GARRISON_REQUEST_UPGRADEABLE_RESULT        = 0x28A0,
    SMSG_GARRISON_UPDATE_FOLLOWER_ACTIVATION_COUNT  = 0x288F,
    SMSG_MESSAGECHAT                                = 0x2B2B,
    SMSG_MONSTER_MOVE                               = 0x2D20,
    SMSG_NAME_QUERY_RESPONSE                        = 0x2682,
    SMSG_NPC_TEXT_UPDATE                            = 0x2681,
    SMSG_PAGE_TEXT_QUERY_RESPONSE                   = 0x2683,
    SMSG_PET_NAME_QUERY_RESPONSE                    = 0x2684,
    SMSG_QUEST_QUERY_RESPONSE                       = 0x2A12,
    SMSG_UITIME                                     = 0x26D4,
    CMSG_ADD_BATTLE_PET                             = 0x7a00,
    CMSG_ADD_NEW_TOY_TO_BOX                         = 0x7a01,
    CMSG_ADD_VOICE_IGNORE                           = 0x7a02,
    CMSG_AREATRIGGER                                = 0x7a03,
    CMSG_ARENA_TEAM_ACCEPT                          = 0x7a04,
    CMSG_ARENA_TEAM_CREATE                          = 0x7a05,
    CMSG_ARENA_TEAM_DECLINE                         = 0x7a06,
    CMSG_ARENA_TEAM_DISBAND                         = 0x7a07,
    CMSG_ARENA_TEAM_INVITE                          = 0x7a08,
    CMSG_ARENA_TEAM_LEADER                          = 0x7a09,
    CMSG_ARENA_TEAM_LEAVE                           = 0x7a0a,
    CMSG_ARENA_TEAM_QUERY                           = 0x7a0b,
    CMSG_ARENA_TEAM_REMOVE                          = 0x7a0c,
    CMSG_ARENA_TEAM_ROSTER                          = 0x7a0d,
    CMSG_ATTACKSTOP                                 = CMSG_ATTACK_STOP,
    CMSG_ATTACKSWING                                = CMSG_ATTACK_SWING,
    CMSG_AUCTION_HELLO                              = CMSG_AUCTION_HELLO_REQUEST,
    CMSG_AUTOEQUIP_GROUND_ITEM                      = 0x7a11,
    CMSG_AUTOEQUIP_ITEM                             = CMSG_AUTO_EQUIP_ITEM,
    CMSG_AUTOEQUIP_ITEM_SLOT                        = CMSG_AUTO_EQUIP_ITEM_SLOT,
    CMSG_AUTOSTORE_BAG_ITEM                         = 0x7a14,
    CMSG_AUTOSTORE_GROUND_ITEM                      = 0x7a15,
    CMSG_AUTO_DECLINE_GUILD_INVITES                 = 0x7a16,
    CMSG_BATTLEFIELD_MGR_ENTRY_INVITE_RESPONSE      = 0x7a17,
    CMSG_BATTLEFIELD_MGR_QUEUE_EXIT_REQUEST         = 0x7a18,
    CMSG_BATTLEFIELD_MGR_QUEUE_INVITE_RESPONSE      = 0x7a19,
    CMSG_BATTLEFIELD_MGR_QUEUE_REQUEST              = 0x7a1a,
    CMSG_BATTLEFIELD_REQUEST_SCORE_DATA             = 0x7a1b,
    CMSG_BATTLEMASTER_JOIN_ARENA_SKIRMISH           = 0x7a1c,
    CMSG_BATTLE_PAY_GET_PRODUCT_LIST_QUERY          = CMSG_BATTLE_PAY_GET_PRODUCT_LIST,
    CMSG_BATTLE_PETS_RECONVERT                      = 0x7a1e,
    CMSG_BATTLE_PET_DELETE_JOURNAL                  = 0x7a1f,
    CMSG_BATTLE_PET_SET_COLLAR                      = 0x7a20,
    CMSG_BATTLE_PET_SET_LEVEL                       = 0x7a21,
    CMSG_BLACK_MARKET_PLACE_BID                     = 0x7a22,
    CMSG_BOT_DETECTED2                              = 0x7a23,
    CMSG_BUYBACK_ITEM                               = 0x7a24,
    CMSG_CALENDAR_EVENT_REMOVE_INVITE               = 0x7a25,
    CMSG_CALENDAR_EVENT_SIGNUP                      = 0x7a26,
    CMSG_CALENDAR_GET_CALENDAR                      = 0x7a27,
    CMSG_CHANGEPLAYER_DIFFICULTY                    = 0x7a28,
    CMSG_CHANGE_SEATS_ON_CONTROLLED_VEHICLE         = 0x7a29,
    CMSG_CHANNEL_ANNOUNCEMENTS                      = 0x7a2a,
    CMSG_CHANNEL_BAN                                = 0x7a2b,
    CMSG_CHANNEL_DISPLAY_LIST                       = 0x7a2c,
    CMSG_CHANNEL_INVITE                             = 0x7a2d,
    CMSG_CHANNEL_KICK                               = 0x7a2e,
    CMSG_CHANNEL_LIST                               = 0x7a2f,
    CMSG_CHANNEL_MODERATOR                          = 0x7a30,
    CMSG_CHANNEL_MUTE                               = 0x7a31,
    CMSG_CHANNEL_OWNER                              = 0x7a32,
    CMSG_CHANNEL_PASSWORD                           = 0x7a33,
    CMSG_CHANNEL_SET_OWNER                          = 0x7a34,
    CMSG_CHANNEL_SILENCE_ALL                        = 0x7a35,
    CMSG_CHANNEL_SILENCE_VOICE                      = 0x7a36,
    CMSG_CHANNEL_UNBAN                              = 0x7a37,
    CMSG_CHANNEL_UNMODERATOR                        = 0x7a38,
    CMSG_CHANNEL_UNMUTE                             = 0x7a39,
    CMSG_CHANNEL_UNSILENCE_ALL                      = 0x7a3a,
    CMSG_CHANNEL_UNSILENCE_VOICE                    = 0x7a3b,
    CMSG_CHANNEL_VOICE_OFF                          = 0x7a3c,
    CMSG_CHANNEL_VOICE_ON                           = 0x7a3d,
    CMSG_CHAR_RENAME                                = CMSG_CHARACTER_RENAME_REQUEST,
    CMSG_CHAT_FILTERED                              = 0x7a3f,
    CMSG_CHAT_IGNORED                               = 0x7a40,
    CMSG_CHEAT_BATTLE_PET_SET_QUALITY               = 0x7a41,
    CMSG_COMMENTATOR_GET_PARTY_INFO                 = 0x7a42,
    CMSG_COMMENTATOR_INSTANCE_COMMAND               = 0x7a43,
    CMSG_COMMENTATOR_SKIRMISH_QUEUE_COMMAND         = 0x7a44,
    CMSG_COMPLAIN                                   = 0x7a45,
    CMSG_DANCE_QUERY                                = 0x7a46,
    CMSG_DECLINE_CHANNEL_INVITE                     = 0x7a47,
    CMSG_DEL_VOICE_IGNORE                           = 0x7a48,
    CMSG_DEPOSIT_ALL_REAGENTS                       = 0x7a49,
    CMSG_DFGET_SYSTEM_INFO                          = 0x7a4a,
    CMSG_DFSET_ROLES                                = 0x7a4b,
    CMSG_DISMISS_CONTROLLED_VEHICLE                 = 0x7a4c,
    CMSG_DUEL_PROPOSED                              = 0x7a4d,
    CMSG_FORCE_MOVE_ROOT_ACK                        = 0x7a4e,
    CMSG_FORCE_MOVE_UNROOT_ACK                      = 0x7a4f,
    CMSG_GAMEOBJECT_REPORT_USE                      = 0x7a50,
    CMSG_GAMEOBJECT_USE                             = CMSG_GAME_OBJ_USE,
    CMSG_GAMESPEED_SET                              = 0x7a52,
    CMSG_GAMETIME_SET                               = 0x7a53,
    CMSG_GARRISON_ADD_FOLLOWER_XPCHEAT              = 0x7a54,
    CMSG_GARRISON_ADD_MISSION_CHEAT                 = 0x7a55,
    CMSG_GARRISON_ADD_UNIQUE_FOLLOWER_CHEAT         = 0x7a56,
    CMSG_GARRISON_CREATE_CHEAT                      = 0x7a57,
    CMSG_GARRISON_DECOMISSION_SHIP                  = 0x7a58,
    CMSG_GARRISON_DELETE_CHEAT                      = 0x7a59,
    CMSG_GARRISON_FOLLOWER_RENAME                   = 0x7a5a,
    CMSG_GARRISON_FORCE_BUILDING_ACTIVE             = 0x7a5b,
    CMSG_GARRISON_LEARN_BLUEPRINT_CHEAT             = 0x7a5c,
    CMSG_GARRISON_LEARN_BUILDING_SPECIALIZATION_CHEAT= 0x7a5d,
    CMSG_GARRISON_LIST_FOLLOWERS_CHEAT              = 0x7a5e,
    CMSG_GARRISON_MISSION_NPC_HELLO                 = 0x7a5f,
    CMSG_GARRISON_PLACE_BUILDING_CHEAT              = 0x7a60,
    CMSG_GARRISON_PORT_CHEAT                        = 0x7a61,
    CMSG_GARRISON_REMOVE_BUILDING_CHEAT             = 0x7a62,
    CMSG_GARRISON_REMOVE_FOLLOWER_CHEAT             = 0x7a63,
    CMSG_GARRISON_SET_ACTIVE_BUILDING_SPECIALIZATION= 0x7a64,
    CMSG_GARRISON_SET_ACTIVE_BUILDING_SPECIALIZATION_CHEAT= 0x7a65,
    CMSG_GARRISON_SET_FOLLOWER_ITEM_LEVEL_CHEAT     = 0x7a66,
    CMSG_GARRISON_SET_LEVEL_CHEAT                   = 0x7a67,
    CMSG_GARRISON_UPGRADE_BUILDING_CHEAT            = 0x7a68,
    CMSG_GETDEATHBINDZONE                           = 0x7a69,
    CMSG_GET_MAIL_LIST                              = 0x7a6a,
    CMSG_GET_MIRRORIMAGE_DATA                       = 0x7a6b,
    CMSG_GHOST                                      = 0x7a6c,
    CMSG_GMSURVEY_SUBMIT                            = 0x7a6d,
    CMSG_GMTICKET_GET_CASE_STATUS                   = 0x7a6e,
    CMSG_GMTICKET_SYSTEMSTATUS                      = 0x7a6f,
    CMSG_GM_REPORT_LAG                              = 0x7a70,
    CMSG_GOSSIP_HELLO                               = 0x7a71,
    CMSG_GROUP_ASSIGNMENT                           = 0x7a72,
    CMSG_GROUP_ASSISTANT_LEADER                     = 0x7a73,
    CMSG_GROUP_CHANGE_SUB_GROUP                     = 0x7a74,
    CMSG_GROUP_REQUEST_JOIN_UPDATES                 = 0x7a75,
    CMSG_GROUP_SWAP_SUB_GROUP                       = 0x7a76,
    CMSG_HANDSHAKE                                  = 0x7a77,
    CMSG_INSPECT_HONOR_STATS                        = 0x7a78,
    CMSG_ITEM_REFUND                                = 0x7a79,
    CMSG_ITEM_REFUND_INFO                           = 0x7a7a,
    CMSG_JOIN_CHANNEL                               = 0x7a7b,
    CMSG_LEAVE_BATTLEFIELD                          = 0x7a7c,
    CMSG_LEAVE_CHANNEL                              = 0x7a7d,
    CMSG_LFG_GET_PLAYER_INFO                        = 0x7a7e,
    CMSG_LFG_GET_STATUS                             = 0x7a7f,
    CMSG_LFG_JOIN                                   = 0x7a80,
    CMSG_LFG_LEAVE                                  = 0x7a81,
    CMSG_LFG_LIST_APPLY_FOR_GROUP                   = 0x7a82,
    CMSG_LFG_LIST_INVITATION_ANSWER                 = 0x7a83,
    CMSG_LFG_LIST_REMOVE_APPLICANT                  = 0x7a84,
    CMSG_LFG_PROPOSAL_RESULT                        = 0x7a85,
    CMSG_LFG_SET_BOOT_VOTE                          = 0x7a86,
    CMSG_LFG_SET_COMMENT                            = 0x7a87,
    CMSG_LFG_TELEPORT                               = 0x7a88,
    CMSG_LF_GUILD_POST_REQUEST                      = 0x7a89,
    CMSG_LIST_STABLE_PETS                           = 0x7a8a,
    CMSG_LOAD_SCREEN                                = 0x7a8b,
    CMSG_LOOT                                       = 0x7a8c,
    CMSG_MANEUVER_START                             = 0x7a8d,
    CMSG_MEETINGSTONE_INFO                          = 0x7a8e,
    CMSG_MINIGAME_MOVE                              = 0x7a8f,
    CMSG_MOUNTSPECIAL_ANIM                          = 0x7a90,
    CMSG_MOVE_CHNG_TRANSPORT                        = 0x7a91,
    CMSG_MOVE_NOT_ACTIVE_MOVER                      = 0x7a92,
    CMSG_MOVE_TOGGLE_COLLISION_ACK                  = 0x7a93,
    CMSG_NEW_SPELL_SLOT                             = 0x7a94,
    CMSG_PETITION_DECLINE                           = 0x7a95,
    CMSG_PETITION_QUERY                             = 0x7a96,
    CMSG_PETITION_RENAME                            = 0x7a97,
    CMSG_PETITION_SHOWLIST                          = 0x7a98,
    CMSG_PETITION_SIGN                              = 0x7a99,
    CMSG_PET_BATTLE_DEBUG_QUEUE_DUMP                = 0x7a9a,
    CMSG_PET_BATTLE_INPUT_FIRST_PET                 = 0x7a9b,
    CMSG_PET_BATTLE_WILD_LOCATION_FAIL              = 0x7a9c,
    CMSG_PLAYED_TIME                                = 0x7a9d,
    CMSG_PLAYER_DIFFICULTY_CHANGE                   = 0x7a9e,
    CMSG_PLAYER_LOGOUT                              = 0x7a9f,
    CMSG_PLAYER_SAVE_GUILD_EMBLEM                   = 0x7aa0,
    CMSG_PLAYER_VEHICLE_ENTER                       = 0x7aa1,
    CMSG_PLAY_DANCE                                 = 0x7aa2,
    CMSG_QUERY_BATTLEFIELD_STATE                    = 0x7aa3,
    CMSG_QUERY_GUILD_MEMBERS_FOR_RECIPE             = 0x7aa4,
    CMSG_QUERY_GUILD_MEMBER_RECIPES                 = 0x7aa5,
    CMSG_QUERY_GUILD_RECIPES                        = 0x7aa6,
    CMSG_QUESTGIVER_ACCEPT_QUEST                    = 0x7aa7,
    CMSG_QUESTGIVER_CHOOSE_REWARD                   = 0x7aa8,
    CMSG_QUESTGIVER_COMPLETE_QUEST                  = 0x7aa9,
    CMSG_QUESTGIVER_HELLO                           = 0x7aaa,
    CMSG_QUESTGIVER_QUERY_QUEST                     = 0x7aab,
    CMSG_QUESTGIVER_REQUEST_REWARD                  = 0x7aac,
    CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY           = 0x7aad,
    CMSG_QUESTLOG_REMOVE_QUEST                      = 0x7aae,
    CMSG_QUEST_NPC_QUERY                            = 0x7aaf,
    CMSG_REALM_NAME_QUERY                           = 0x7ab0,
    CMSG_REALM_SPLIT                                = 0x7ab1,
    CMSG_REDIRECTION_AUTH_PROOF                     = 0x7ab2,
    CMSG_REPORT_BUG                                 = 0x7ab3,
    CMSG_REPORT_PVP_AFK                             = 0x7ab4,
    CMSG_REPORT_SUGGESTION                          = 0x7ab5,
    CMSG_REQUEST_BATTLEPET_JOURNAL                  = 0x7ab6,
    CMSG_REQUEST_INSPECT_RATED_BG_STATS             = 0x7ab7,
    CMSG_REQUEST_PVP_OPTIONS_ENABLED                = 0x7ab8,
    CMSG_REQUEST_RATED_BG_INFO                      = 0x7ab9,
    CMSG_REQUEST_RATED_BG_STATS                     = 0x7aba,
    CMSG_REQUEST_SET_MISSION_NPC                    = 0x7abb,
    CMSG_REQUEST_TWITTER_STATUS                     = 0x7abc,
    CMSG_RESET_FACTION_CHEAT                        = 0x7abd,
    CMSG_RESTORE_BATTLE_PETS_HEALTH                 = 0x7abe,
    CMSG_RETURN_TO_GRAVEYARD                        = 0x7abf,
    CMSG_SAVE_PLAYER                                = 0x7ac0,
    CMSG_SEARCH_LFG_JOIN                            = 0x7ac1,
    CMSG_SEARCH_LFG_LEAVE                           = 0x7ac2,
    CMSG_SEND_SOR_REQUEST_VIA_BNET_ACCOUNT_ID       = 0x7ac3,
    CMSG_SERVERTIME                                 = 0x7ac4,
    CMSG_SETDEATHBINDPOINT                          = 0x7ac5,
    CMSG_SETSHEATHED                                = 0x7ac6,
    CMSG_SET_ACTIONBAR_TOGGLES                      = 0x7ac7,
    CMSG_SET_ALLOW_LOW_LEVEL_RAID1                  = 0x7ac8,
    CMSG_SET_ALLOW_LOW_LEVEL_RAID2                  = 0x7ac9,
    CMSG_SET_FACTION_ATWAR                          = 0x7aca,
    CMSG_SET_FACTION_CHEAT                          = 0x7acb,
    CMSG_SET_FAVORITE_TOY                           = 0x7acc,
    CMSG_SET_LFG_COMMENT                            = 0x7acd,
    CMSG_SET_PREFERED_CEMETERY                      = 0x7ace,
    CMSG_SET_RELATIVE_POSITION                      = 0x7acf,
    CMSG_SET_SKILL_CHEAT                            = 0x7ad0,
    CMSG_SHOW_ACCOUNT_ACHIEVEMENT                   = 0x7ad1,
    CMSG_SHOW_GARRISON_TRANSFER                     = 0x7ad2,
    CMSG_SPELLCLICK                                 = 0x7ad3,
    CMSG_START_QUEST                                = 0x7ad4,
    CMSG_STOP_DANCE                                 = 0x7ad5,
    CMSG_SUBMIT_BUG                                 = 0x7ad6,
    CMSG_SUBMIT_COMPLAIN                            = 0x7ad7,
    CMSG_SUGGESTION_SUBMIT                          = 0x7ad8,
    CMSG_SUMMON_BATTLEPET_COMPANION                 = 0x7ad9,
    CMSG_SUSPEND_TOKEN                              = 0x7ada,
    CMSG_SYNC_DANCE                                 = 0x7adb,
    CMSG_TIME_SYNC_RESP                             = 0x7adc,
    CMSG_TIME_SYNC_RESP_FAILED                      = 0x7add,
    CMSG_UITIME_REQUEST                             = 0x7ade,
    CMSG_UNREGISTER_ALL_ADDON_PREFIXES              = 0x7adf,
    CMSG_UNSET_FACTION_ATWAR                        = 0x7ae0,
    CMSG_VOID_STORAGE_QUERY                         = 0x7ae1,
    CMSG_VOID_STORAGE_UNLOCK                        = 0x7ae2,
    CMSG_VOID_SWAP_ITEM                             = 0x7ae3,
    CMSG_WARGAME_ACCEPT                             = 0x7ae4,
    CMSG_WARGAME_START                              = 0x7ae5,
    CMSG_WHOIS                                      = 0x7ae6,
    SMSG_ACCOUNT_CRITERIA_UPDATE_ALL                = 0x7ae7,
    SMSG_ACCOUNT_INFO_RESPONSE                      = 0x7ae8,
    SMSG_ACCOUNT_PROFILE                            = 0x7ae9,
    SMSG_AE_LOOT_TARGETS_ACK                        = 0x7aea,
    SMSG_APPLY_MOVEMENT_FORCE                       = 0x7aeb,
    SMSG_AREA_SHARE_INFO_RESPONSE                   = 0x7aec,
    SMSG_AREA_SHARE_MAPPINGS_RESPONSE               = 0x7aed,
    SMSG_AREA_TRIGGER_MOVEMENT_UPDATE               = 0x7aee,
    SMSG_ARENA_OPPONENT_SPECIALIZATIONS             = 0x7aef,
    SMSG_AUCTION_BIDDER_LIST_RESULT                 = 0x7af0,
    SMSG_AUCTION_BIDDER_NOTIFICATION                = 0x7af1,
    SMSG_AUCTION_BUYOUT_NOTIFICATION                = 0x7af2,
    SMSG_AUCTION_LIST_PENDING_SALES                 = 0x7af3,
    SMSG_AUCTION_LIST_RESULT                        = 0x7af4,
    SMSG_AUCTION_OWNER_LIST_RESULT                  = 0x7af5,
    SMSG_AURA_CAST_LOG                              = 0x7af6,
    SMSG_AVERAGE_ITEM_LEVEL_INFORM                  = 0x7af7,
    SMSG_BAG_SORT_RESULT                            = 0x7af8,
    SMSG_BATTLEFIELD_MGR_EJECTED                    = 0x7af9,
    SMSG_BATTLEFIELD_MGR_EJECT_PENDING              = 0x7afa,
    SMSG_BATTLEFIELD_MGR_ENTERING                   = 0x7afb,
    SMSG_BATTLEFIELD_MGR_EXIT_REQUEST               = 0x7afc,
    SMSG_BATTLEFIELD_MGR_QUEUE_INVITE               = 0x7afd,
    SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE     = 0x7afe,
    SMSG_BATTLEFIELD_MGR_STATE_CHANGED              = 0x7aff,
    SMSG_BEASTMASTER_FAILED                         = 0x7b00,
    SMSG_BFMGR_ENTRY_INVITE                         = 0x7b01,
    SMSG_BUY_ITEM                                   = 0x7b02,
    SMSG_CALENDAR_EVENT_INITIAL_INVITE              = 0x7b03,
    SMSG_CALENDAR_EVENT_MODERATOR_STATUS            = 0x7b04,
    SMSG_CHALLENGE_MODE_DELETE_LEADER_RESULT        = 0x7b05,
    SMSG_CHALLENGE_MOD_REWARDS                      = 0x7b06,
    SMSG_CHAR_CUSTOMIZE_RESULT                      = 0x7b07,
    SMSG_CHAR_FACTION_CHANGE                        = 0x7b08,
    SMSG_CHAR_RENAME                                = SMSG_CHARACTER_RENAME_RESULT,
    SMSG_GARRISON_FOLLOWER_DELETE_NOTIFY            = SMSG_GARRISON_FOLLOWER_CHANGED_STATUS,
    SMSG_GARRISON_UPDATE_FOLLOWER                   = SMSG_GARRISON_FOLLOWER_CHANGED_STATUS,
    SMSG_CHEAT_PLAYER_LOOKUP                        = 0x7b0a,
    SMSG_CLEAR_ITEM_CHALLENGE_MODE_DATA             = 0x7b0b,
    SMSG_CLIENT_CONTROL_UPDATE                      = 0x7b0c,
    SMSG_COMPLAIN_RESULT                            = 0x7b0d,
    SMSG_DBLOOKUP_RESULTS                           = 0x7b0e,
    SMSG_DEBUG_AISTATE                              = 0x7b0f,
    SMSG_DEBUG_RUNE_REGEN                           = 0x7b10,
    SMSG_DISMOUNTRESULT                             = 0x7b11,
    SMSG_DUEL_INBOUNDS                              = 0x7b12,
    SMSG_DUMP_RIDE_TICKETS_RESPONSE                 = 0x7b13,
    SMSG_DYNAMIC_DROP_ROLL_RESULT                   = 0x7b14,
    SMSG_EQUIPMENT_SET_LIST                         = 0x7b15,
    SMSG_FORCE_ACTION_SHOW_RESPONSE                 = 0x7b16,
    SMSG_GAMEOBJECT_CUSTOM_ANIM                     = 0x7b17,
    SMSG_GAMEOBJECT_DESPAWN                         = 0x7b18,
    SMSG_GAMEOBJECT_RESET_STATE                     = 0x7b19,
    SMSG_GAME_EVENT_DEBUG_LOG                       = 0x7b1a,
    SMSG_GARRISON_SET_MISSION_NPC                   = 0x7b1c,
    SMSG_GHOST                                      = 0x7b1e,
    SMSG_GHOSTEE_GONE                               = 0x7b1f,
    SMSG_GM_CHARACTER_SAVE_FAILURE                  = 0x7b20,
    SMSG_GM_FREEZE_FAILURE                          = 0x7b21,
    SMSG_GM_NAMED_POINTS                            = 0x7b22,
    SMSG_GM_RESURRECT_FAILURE                       = 0x7b23,
    SMSG_GM_REVEAL_TO                               = 0x7b24,
    SMSG_GM_SILENCE                                 = 0x7b25,
    SMSG_GUILD_BANK_LOG_QUERY_RESULT                = 0x7b26,
    SMSG_GUILD_BANK_QUERY_TEXT_RESULT               = 0x7b27,
    SMSG_GUILD_CHALLENGE_UPDATED                    = 0x7b28,
    SMSG_GUILD_REWARDS_LIST                         = 0x7b29,
    SMSG_HANDSHAKE                                  = 0x7b2a,
    SMSG_IMMIGRANT_HOST_SEARCH_LOG                  = 0x7b2b,
    SMSG_INIT_CURRENCY                              = 0x7b2c,
    SMSG_INSPECT_RATED_BG_STATS                     = 0x7b2d,
    SMSG_INSPECT_TALENT                             = 0x7b2e,
    SMSG_ITEM_ADD_PASSIVE                           = 0x7b2f,
    SMSG_ITEM_BONUS_DEBUG                           = 0x7b30,
    SMSG_LEARNED_SPELL                              = 0x7b31,
    SMSG_LEVELUP_INFO                               = 0x7b32,
    SMSG_LFGUILD_APPLICANT_LIST_CHANGED             = 0x7b33,
    SMSG_LFGUILD_APPLICATIONS                       = 0x7b34,
    SMSG_LFGUILD_APPLICATIONS_LIST_CHANGED          = 0x7b35,
    SMSG_LFGUILD_BROWSE                             = 0x7b36,
    SMSG_LFGUILD_COMMAND_RESULT                     = 0x7b37,
    SMSG_LFGUILD_POST                               = 0x7b38,
    SMSG_LFGUILD_RECRUITS                           = 0x7b39,
    SMSG_LFG_LIST_APPLICANT_GROUP_INVITE            = 0x7b3a,
    SMSG_LFG_LIST_APPLICANT_LIST_UPDATE             = 0x7b3b,
    SMSG_LFG_LIST_APPLY_FOR_GROUP_RESULT            = 0x7b3c,
    SMSG_LFG_LIST_SEARCH_RESULT                     = 0x7b3d,
    SMSG_LFG_OPEN_FROM_GOSSIP                       = 0x7b3e,
    SMSG_LFG_ROLE_CHOSEN                            = 0x7b3f,
    SMSG_LFG_SEARCH_RESULT                          = 0x7b40,
    SMSG_LFG_UPDATE_LIST                            = 0x7b41,
    SMSG_LFG_UPDATE_PARTY                           = 0x7b42,
    SMSG_LFG_UPDATE_PLAYER                          = 0x7b43,
    SMSG_LFG_UPDATE_SEARCH                          = 0x7b44,
    SMSG_LFG_UPDATE_STATUS_NONE                     = 0x7b45,
    SMSG_LIST_INVENTORY                             = 0x7b46,
    SMSG_LIST_TARGETS                               = 0x7b47,
    SMSG_LOOT_START_ROLL                            = 0x7b48,
    SMSG_MOVE_CHARACTER_CHEAT_FAILURE               = 0x7b49,
    SMSG_MOVE_CHARACTER_CHEAT_SUCCESS               = 0x7b4a,
    SMSG_MOVE_FEATHER_FALL                          = 0x7b4b,
    SMSG_MOVE_LAND_WALK                             = 0x7b4c,
    SMSG_MOVE_NORMAL_FALL                           = 0x7b4d,
    SMSG_MOVE_SET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY= 0x7b4e,
    SMSG_MOVE_SET_HOVER                             = 0x7b4f,
    SMSG_MOVE_UNSET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY= 0x7b50,
    SMSG_MOVE_UNSET_HOVER                           = 0x7b51,
    SMSG_MOVE_WATER_WALK                            = 0x7b52,
    SMSG_OAUTH_SAVED_DATA                           = 0x7b53,
    SMSG_OPEN_SHIPMENT_NPCFROM_GOSSIP               = 0x7b54,
    SMSG_PARTY_MEMBER_STATE_FULL                    = 0x7b55,
    SMSG_PARTY_MEMBER_STATE_PARTIAL                 = 0x7b56,
    SMSG_PETITION_DECLINED                          = 0x7b57,
    SMSG_PETITION_RENAME                            = 0x7b58,
    SMSG_PET_BATTLE_PVPCHALLENGE                    = 0x7b59,
    SMSG_PLAYER_DIFFICULTY_CHANGE_RESULT            = 0x7b5a,
    SMSG_PLAYER_NOT_FOUND_FAILURE                   = 0x7b5b,
    SMSG_PLAYER_TABAR_VENDOR_SHOW                   = 0x7b5c,
    SMSG_PRE_RESURRECT                              = 0x7b5d,
    SMSG_PROCRESIST                                 = 0x7b5e,
    SMSG_PROFILE_DATA_RESPONSE                      = 0x7b5f,
    SMSG_PVPLOG_DATA                                = 0x7b60,
    SMSG_QUEST_COMPLETION_NPCRESPONSE               = 0x7b61,
    SMSG_QUEST_POIQUERY_RESPONSE                    = 0x7b62,
    SMSG_RAID_INSTANCE_INFO                         = 0x7b63,
    SMSG_READ_ITEM_FAILED                           = 0x7b64,
    SMSG_READ_ITEM_OK                               = 0x7b65,
    SMSG_REALM_SPLIT                                = 0x7b66,
    SMSG_RECEIVED_MAIL                              = 0x7b67,
    SMSG_REQUEST_TWITTER_STATUS_RESPONSE            = 0x7b68,
    SMSG_RESIST_LOG                                 = 0x7b69,
    SMSG_ROLL_POLL_INFORM                           = 0x7b6a,
    SMSG_SCENARIO_POI                               = 0x7b6b,
    SMSG_SCENE_OBJECT_PET_BATTLE_REMPLACEMENTS_MADE = 0x7b6c,
    SMSG_SCRIPT_MESSAGE                             = 0x7b6d,
    SMSG_SELL_ITEM                                  = 0x7b6e,
    SMSG_SEND_MAIL_RESULT                           = 0x7b6f,
    SMSG_SERVER_BUCK_DATA                           = 0x7b70,
    SMSG_SERVER_BUCK_DATA_START                     = 0x7b71,
    SMSG_SERVER_INFO_QUERY_RESPONSE                 = 0x7b72,
    SMSG_SERVER_INFO_RESPONSE                       = 0x7b73,
    SMSG_SERVER_PERF                                = 0x7b74,
    SMSG_SET_FACTION_ATWAR                          = 0x7b75,
    SMSG_SET_ITEM_CHALLENGE_MODE_DATA               = 0x7b76,
    SMSG_SET_PHASE_SHIFT                            = 0x7b77,
    SMSG_SET_PROMOTION_RESPONSE                     = 0x7b78,
    SMSG_SET_RAID_DIFFICULTY                        = 0x7b79,
    SMSG_SET_SERVER_WOW_TIME                        = 0x7b7a,
    SMSG_SHOW_RATINGS                               = 0x7b7b,
    SMSG_SHOW_ZONES_CHEAT_RESULT                    = 0x7b7c,
    SMSG_SPELL_CHANCE_PROC_LOG                      = 0x7b7d,
    SMSG_SPELL_PROCS_PER_MINUTE_LOG                 = 0x7b7e,
    SMSG_SPELL_PROC_SCRIPT_LOG                      = 0x7b7f,
    SMSG_SPLINE_MOVE_COLLISION_DISABLE              = 0x7b80,
    SMSG_SPLINE_MOVE_COLLISION_ENABLE               = 0x7b81,
    SMSG_SPLINE_MOVE_GRAVITY_DISABLE                = 0x7b82,
    SMSG_SPLINE_MOVE_GRAVITY_ENABLE                 = 0x7b83,
    SMSG_SPLINE_MOVE_ROOT                           = 0x7b84,
    SMSG_SPLINE_MOVE_SET_FEATHER_FALL               = 0x7b85,
    SMSG_SPLINE_MOVE_SET_FLIGHT_BACK_SPEED          = 0x7b86,
    SMSG_SPLINE_MOVE_SET_FLIGHT_SPEED               = 0x7b87,
    SMSG_SPLINE_MOVE_SET_FLYING                     = 0x7b88,
    SMSG_SPLINE_MOVE_SET_HOVER                      = 0x7b89,
    SMSG_SPLINE_MOVE_SET_LAND_WALK                  = 0x7b8a,
    SMSG_SPLINE_MOVE_SET_NORMAL_FALL                = 0x7b8b,
    SMSG_SPLINE_MOVE_SET_PITCH_RATE                 = 0x7b8c,
    SMSG_SPLINE_MOVE_SET_RUN_BACK_SPEED             = 0x7b8d,
    SMSG_SPLINE_MOVE_SET_RUN_MODE                   = 0x7b8e,
    SMSG_SPLINE_MOVE_SET_RUN_SPEED                  = 0x7b8f,
    SMSG_SPLINE_MOVE_SET_SWIM_BACK_SPEED            = 0x7b90,
    SMSG_SPLINE_MOVE_SET_SWIM_SPEED                 = 0x7b91,
    SMSG_SPLINE_MOVE_SET_TURN_RATE                  = 0x7b92,
    SMSG_SPLINE_MOVE_SET_WALK_MODE                  = 0x7b93,
    SMSG_SPLINE_MOVE_SET_WALK_SPEED                 = 0x7b94,
    SMSG_SPLINE_MOVE_SET_WATER_WALK                 = 0x7b95,
    SMSG_SPLINE_MOVE_START_SWIM                     = 0x7b96,
    SMSG_SPLINE_MOVE_STOP_SWIM                      = 0x7b97,
    SMSG_SPLINE_MOVE_UNROOT                         = 0x7b98,
    SMSG_SPLINE_MOVE_UNSET_FLYING                   = 0x7b99,
    SMSG_SPLINE_MOVE_UNSET_HOVER                    = 0x7b9a,
    SMSG_STABLE_RESULT                              = 0x7b9b,
    SMSG_STANDSTATE_UPDATE                          = 0x7b9c,
    SMSG_SUPERCEDED_SPELL                           = 0x7b9d,
    SMSG_TRAINER_SERVICE                            = 0x7b9e,
    SMSG_TURN_IN_PETITION_RESULTS                   = 0x7b9f,
    SMSG_UNAPPLY_MOVEMENT_FORCE                     = 0x7ba0,
    SMSG_UPDATE_CURRENCY                            = 0x7ba1,
    SMSG_UPDATE_CURRENCY_WEEK_LIMIT                 = 0x7ba2,
    SMSG_UPDATE_SERVER_PLAYER_POSITION              = 0x7ba3,
    SMSG_WARGAME_REQUEST_SUCCESSFULLY_SENT_TO_OPPENENT= 0x7ba4,
    SMSG_WEEKLY_RESET_CURRENCY                      = 0x7ba5,
    SMSG_WHOIS                                      = 0x7ba6,
    SMSG_XPGAIN_ABORTED                             = 0x7ba7,
};
...
inline std::string GetOpcodeNameForLogging(OpcodeClient id)
{
    return GetOpcodeNameForLogging(uint32(id), WOW_CLIENT_TO_SERVER);
}

inline std::string GetOpcodeNameForLogging(OpcodeServer id)
{
    return GetOpcodeNameForLogging(uint32(id), WOW_SERVER_TO_CLIENT);
}


inline bool CanBeSentDuringInterRealm(uint32 id)
{
    switch (id)
    {
        case SMSG_CHAT:
