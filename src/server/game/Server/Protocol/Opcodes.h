...
enum OpcodeClient : uint32
{
    ...
    // Draenor name aliases / leftovers
...
enum OpcodeServer : uint32
{
    ...
    SMSG_GARRISON_FOLLOWER_DELETE_NOTIFY            = SMSG_GARRISON_REMOVE_FOLLOWER_RESULT,
...
// Draenor code uses Opcodes as a generic opcode id type.
using Opcodes = uint32;
