...
bool OutdoorPvP::DelCreature(uint32 p_Type)
{
    ...
    {
        TC_LOG_DEBUG("outdoorpvp", "OutdoorPvP::DelCreature, creature type %u was already deleted", p_Type);
        return false;
    }
    ...
    TC_LOG_DEBUG("outdoorpvp", "OutdoorPvP::DelCreature, deleting creature type %u", p_Type);
